...
const CURRENT_VERSION = '1.0.5 Beta';
...
const VERSION_CHECK_URLS = [
  'https://raw.githubusercontent.com/Kotelya277/KotelyaTV/main/VERSION.txt',
  'https://cdn.jsdelivr.net/gh/Kotelya277/KotelyaTV/VERSION.txt',
];
